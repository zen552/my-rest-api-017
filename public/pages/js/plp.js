                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="/book/`+item.id+`" class="product-thumbnail">
                                                <img src="`+item.gambar+`" alt="Product Images" height="300">
                                            </a>
                                            ...
                                            <div class="product-content">
                                                <h6 class="product-title">
                                                    <a href="/book/`+item.id+`">`+item.nama_item+`</a>
                                                </h6>
                                                <small class="text-color-primary">`+item.Producer+`</small>
                                                <div class="product-price">
                                                    <span class="new-price">IDR `+parseFloat(item.harga).toLocaleString()+`</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>`;
