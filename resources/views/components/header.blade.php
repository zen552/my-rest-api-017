            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-lg-3 col-6">
                    ...
                    <div class="logo_hidden text-start">
                        <a href="{{route('home') }}"><img src="{{asset('assets/images/logo/logo.png')}}" alt="" style="height:48px"></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-lg-3 col-6">
                    <div class="header-right-side text-end">
                        ...
                        <div class="header-right-items d-none d-md-block">
                            @if(@$_COOKIE['ut'])
                            <div class="dropdown">
                                <a href="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                ...
                <div class="helendo-tabs">
                    <ul class="nav" role="tablist">
                        <li class="tab__item nav-item active">
                            <a href="nav-link active" data-bs-toggle="tab" href="#tab_list_06" role="tab">Login</a>
                        </li>
                        <li class="tab__item nav-item">
                            <a href="nav-link" data-bs-toggle="tab" href="#tab_list_07" role="tab">Our Register</a>
                        </li>
