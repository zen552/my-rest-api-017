                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        <div class="product-details-content">
                            ...
                            <h5 class="font-weight--reguler mb-10" id="product-nama-item"></h5>
                            ...
                            <h3 class="harga" id="product-harga"></h3>
                            ...
                            <div class="quickview-action-wrap mt-30">
                                <div class="quickview-cart-box">
                                    ...
                                    <div class="text-color-primary product-add-to-cart-is-disabled"
